...
| <a name="input_edb_version"></a> [edb\_version](#input\_edb\_version) | Version of the PostgreSQL instance to provision. If no value is passed, the current preferred version of IBM Cloud Databases is used. | `string` | `null` | no |
