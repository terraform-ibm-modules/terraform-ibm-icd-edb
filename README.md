...
[![latest release](https://img.shields.io/github/v/release/terraform-ibm-modules/terraform-ibm-icd-edb-postgresql?logo=GitHub&sort=semver)](https://github.com/terraform-ibm-modules/terraform-ibm-icd-edb-postgresql/releases/latest)
...
module "postgresql_db" {
  ...
  source            = "git::https://github.com/terraform-ibm-modules/terraform-ibm-icd-edb-postgresql?ref=main"
